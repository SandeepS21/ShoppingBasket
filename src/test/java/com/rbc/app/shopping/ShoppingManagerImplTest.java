...
public class ShoppingManagerImplTest {
	...
	public void getBasketCostWithOneItem() throws Exception {
		Basket basket = new Basket();
		Item item = new Item("Banana", new BigDecimal(0.80));
	...
	public void getBasketCostWith1Item3Quanity() throws Exception {
		Basket basket = new Basket();
		String name = "Banana";
		BigDecimal price = new BigDecimal(0.20);
	...
	@Test
	public void getBasketCostWith3ItemQuantity1each() throws Exception {
		Basket basket = new Basket();
		Item item1 = new Item("Banana", new BigDecimal(0.20));
		Item item2 = new Item("Apple", new BigDecimal(0.30));
		Item item3 = new Item("Orange", new BigDecimal(0.60));
		basket.addItemToBasket(item1);
		basket.addItemToBasket(item2);
		basket.addItemToBasket(item3);
	...
	public void getBasketCostWithMultiItemMultiQuanity() throws Exception {
		...
		Item item1 = new Item("Banana", new BigDecimal(0.20));
		Item item2 = new Item("Apple", new BigDecimal(0.30));
		Item item3 = new Item("Orange", new BigDecimal(0.50));
		Item item4 = new Item("Banana", new BigDecimal(0.20));
		Item item5 = new Item("Orange", new BigDecimal(0.50));
		Item item6 = new Item("Orange", new BigDecimal(0.50));
		basket.addItemToBasket(item1);
		basket.addItemToBasket(item2);
		basket.addItemToBasket(item3);
	...
	public void getQuantityForAvailableItem() throws Exception {
		Basket basket = new Basket();
		Item item1 = new Item("Banana", new BigDecimal(0.60));
		Item item2 = new Item("Banana", new BigDecimal(0.50));
		Item item3 = new Item("Orange", new BigDecimal(0.40));
		basket.addItemToBasket(item1);
		basket.addItemToBasket(item2);
		basket.addItemToBasket(item3);
